...
test('sidebar admin memuat kelompok kesiswaan', function () {
    ...
    expect($isi)->toContain('kesiswaanNavItems')
        ...
        // Guru piket mengisi absensi siswa dari sidebar, jadi halaman absensi
        // siswa harus terjangkau admin.
        ->and($isi)->toContain('@/routes/absensi-siswa');
});
...
test('halaman siswa, kelas, dan absensi siswa terjangkau admin', function () {
